<%@ Page Title="Modelos" Language="C#" MasterPageFile="~/View/Comercial/AdmVentas/SiteAdmVentas.master" AutoEventWireup="true" CodeFile="AdministracionModelos.aspx.cs" Inherits="Com_Adm_Default_" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="container">
        <div class="row mb-3">
            <div class="col text-center">
                <button type="button" id="BtnCrearComponente" onclick="OpenModal()" class="btn btn-mangotango btn-lg">Crear Modelo</button>
            </div>
        </div>
        ...
        <div class="card mb-3 border-info">
            ...
            <div class="col-lg-8 mb-3 col-12">
                <div class="form-row">
                    ...
                    <div class="col-2">
                        <asp:Button runat="server" ID="SearchBtn" OnClick="SearchBtn_Click" Text="Buscar" CssClass="boton outline-mangotango" />
                    </div>
    ...
    <!--MODAL Crear Modelo-->
    <div class="modal fade" id="modalCrearModelo" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
                        <h3 class="modal-title" id="gridSystemModalLabel">Crear Modelo </h3>
                ...
                <div class="row mb-2">
                    <div class="col-12 col-lg-6">
                        <div class=" form-group">
                            <label for="TxtModelName">Nombre* :</label><asp:TextBox runat="server" ID="TxtModelName" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ControlToValidate="TxtModelName" ValidationGroup="CreateModel" ErrorMessage="Campo obligatorio" ForeColor="Red" runat="server"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                        ...
                        <div class=" form-group">
                           <label for="FileUpFoto">Adjuntar Foto</label> <asp:FileUpload runat="server" ID="FileUpFoto" CssClass="form-control-file" />
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator7"
                               ...
                               ValidationGroup="CreateModel" SetFocusOnError="true"></asp:RegularExpressionValidator>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 text-right">
                        <div class="form-group">
                            <asp:Button runat="server" ID="BtnCreateModel" ValidationGroup="CreateModel" OnClick="BtnCreateModel_Click" CssClass="btn btn-outline-info" Text="Siguiente" />
                        </div>
                    </div>
                </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content modal-sm">
          ...
          <div class="modal-body">
              <div class="row">
                  <div class="col">
                      <label>Seguro que desea eliminar este Modelo?</label>
                  </div>
              </div>
          </div>
          <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                  <asp:Button runat="server" ID="BtnDeleteItem" OnClick="BtnDeleteItem_Click" CssClass="btn btn-primary"  Text="SI" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.filas').click(function () {
                ...
                var HASPIECES = $(this).find("td").eq(8).html();
