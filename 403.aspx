<%@ Page Title="Glasser" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="403.aspx.cs" Inherits="_Default" %>
            ...
            <div class="error">
                <div class="container-floud">
                    <div class="col-xs-12 ground-color text-center">
                        ...
                        <h2 class="h1">Sorry! <asp:Label runat="server" ID="Mensaje"></asp:Label></h2>
                    </div>
                </div>
            </div>
        <!-- Error Page -->
